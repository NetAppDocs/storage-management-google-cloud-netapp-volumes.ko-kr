...
summary: NetApp 콘솔은 Google Cloud NetApp Volumes API에 액세스해야 하며 Google Cloud 서비스 계정을 통해 적절한 권한이 필요합니다. 
---
...
[role="lead"]
NetApp 콘솔에는 Google Cloud 서비스 계정을 통한 올바른 권한이 필요합니다.



== 서비스 계정 설정

NetApp 콘솔이 Google Cloud 프로젝트에 액세스할 수 있도록 다음 작업을 완료하세요.
